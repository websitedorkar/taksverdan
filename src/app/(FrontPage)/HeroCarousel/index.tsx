...
const HeroCarousel = () => {
    ...
    <div className='p-4'>
        ...
        <div className="relative rounded-xl overflow-hidden bg-slate-100">
            ...
            <div className="absolute top-1/2 start-0 end-0 z-10 w-full flex items-center gap-[8px] justify-between px-4">
                {/* Arrow Left */}
                ...
                {slides.map(slide => {
                    return (
                        <SwiperSlide key={slide.id}>
                            <div className="bg-slate-100 flex flex-col justify-end bg-[bottom_center] bg-cover px-4 py-[30px] text-center min-h-[660px]" style={{ backgroundImage: `url(${slide.thumb.src})` }}></div>
                        </SwiperSlide>
                    )
                })}
            </Swiper>
            ...
            <div className="min-h-[660px] absolute z-20 top-0 start-0 end-0 flex flex-col justify-end p-[40px] text-white gap-4">

            ...
            <div className="flex items-center justify-between mb-5">
                ...
                <div className='inline-flex items-center gap-[25px]'>
                    ...
                    <div className="hidden md:flex items-center gap-[8px]">
                        {/* Arrow Left */}
                        <span className="travel-blog-carousel--prev inline-flex items-center justify-center w-[40px] min-w-[40px] h-[40px] cursor-pointer">
                            <Image src={ArrowLeft} alt='arrow-left' />
                        </span>

                        {/* Arrow Right */}
                        <span className="travel-blog-carousel--next inline-flex items-center justify-center w-[40px] min-w-[40px] h-[40px] cursor-pointer">

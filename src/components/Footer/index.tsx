...
const Heading = ({ title }: { title: string }) => (
    <h3 className='font-poppins text-xl font-medium mb-5'>{ title }</h3>
)
        ...
        <div className="bg-light rounded-2xl">
            <div className="py-[100px]">
                <div className="container">
                    <div className="grid grid-cols-[3fr_2fr_2fr_auto]">
                    {
                                        ...
                                        case 'about':
                                            return (
                                                <div className='footer__block' key={block.id}>
                                                    ...
                                                    <div>
                                                        { block.content && <div className='max-w-[260px] font-inter text-black font-normal text-lg leading-10 mb-7'>{ block.content }</div>}
                                        ...
                                        case 'linklist':
                                            return (
                                                <div className='footer__block' key={block.id}>
                                                    ...
                                                    {block.heading && <Heading title={block.heading} />}
                                                    <ul className='text-lg leading-8 space-y-6 font-inter font-normal text-black'>
